...
public class PartBSolution {
    ...
    public static void listTopVisitedSites(Queue<SiteStats> sites, int n) {
        // WRITE CODE HERE
        sortQueueMaxFirst(sites);//sorts info based on maxVists
        System.out.println("---Listing the sites in order of maxVists:---"+"\n"+sites+"\n");//printing queue on order of maxVists
        recentlyVisited(n);//Top n sites according to number of times visites and recency
    }   
